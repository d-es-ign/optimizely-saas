...
export const AnimatedCTAElement : CTAComponent<CTAElementDataFragment, AnimatedCTALayoutProps> = ({ data: { link, text }, layoutProps, className, ...containerProps }) => {
...
export function isAnimatedTemplate(props?: CTALayoutProps | null) : props is AnimatedCTALayoutProps
{
