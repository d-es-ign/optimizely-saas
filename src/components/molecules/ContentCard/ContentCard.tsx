...
import { darkBackgrounds } from "@/components/utility/config/backgroundColours";
...
const ContentCard = ({
  ...
  const backgroundColourHexCode = backgroundColour;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!hideText && (
          <Text className="tw-text-[22px] tw-text-grey-100">{text}</Text>
        )}
        {!hideCta && !!ctas?.length && (
